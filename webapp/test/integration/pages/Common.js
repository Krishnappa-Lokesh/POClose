sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("srmpocls/POClose/app", ".html");
			sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

			if (sHash) {
				sHash = "#SRMPOCloseApplication-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
			} else {
				sHash = "#SRMPOCloseApplication-display";
			}

			return sUrl + sUrlParameters + sHash;
		}

		return Opa5.extend("srmpocls.POClose.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["srmpocls/POClose/localService/mockserver"], function (mockserver) {
